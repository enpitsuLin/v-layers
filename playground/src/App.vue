...
const vectorAttributions = 'University of Leicester (commissioned by the <a href=\'https://www.arcgis.com/home/item.html?id=d5f05b1dc3dd4d76906c421bc1727805\'>National Trust</a>'
...
const xyzAttributions = 'Tiles © <a href="https://services.arcgisonline.com/ArcGIS/rest/services/World_Topo_Map/MapServer">ArcGIS</a>'
</script>
    ...
    <Map :view="defaultView">
      <Layer.Tile>
        <Source.XYZ
          ...
          :attributions="xyzAttributions"
        />
      </Layer.Tile>
      <Layer.Vector :style="getLayerStyle" :opacity="0.7">
        <Source.Vector
          :url="getUrl"
          :format="new EsriJSON()"
          :strategy="tileStrategy(createXYZ({ tileSize: 512 }))"
          :attributions="vectorAttributions"
        />
      </Layer.Vector>
    </Map>
  </div>
